...
5. **必须回写文档**：任务执行后必须更新 `status.md`、`003-施工文档.md`、`003-文件改动记录.md`、`onlyAI/operations-log.md`。
...
6. 完成后执行记忆回写；如有必要，生成 `summary.md` 汇总结果。
...
4. 修复完成后同步更新记忆，并在需要时补充 `summary.md`。
...
5. 全部完成后自动生成 `summary.md`，并执行记忆回写。
